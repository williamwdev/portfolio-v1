    ...
    return (
        <div className="about-container">
          ...
          <p className="about-me-intro">
            ...
            Web Developer specializing in PostgresQL, Express.js, React.js, and
            Node.js (PERN) stack. Since building my first gaming PC at the age
            of 12 in order to gain a competitive edge in Counter-Strike, I have
            been fascinated by the world of computers. I want to use web
            development as a platform to intermarry my background in
            Biochemistry and Economics with my passion for technology.
            <br />
          </p>
